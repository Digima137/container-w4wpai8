...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-w4wpai8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-w4wpai8.containers.anotherwebservice.com/
...
```
git clone git@github.com:Digima137/container-w4wpai8.git
cd container-w4wpai8
```
...
```
docker attach container-w4wpai8
```
